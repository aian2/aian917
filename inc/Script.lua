...
#      ███    ██▄ ███    ███          ███          ███ -› Dev : @OMMMM
#      ███    ███ ███    ███    ▄█    ███    ▄█    ███
#    ▄█████████▀   ▀██████▀   ▄████████▀   ▄████████▀  -› Source TH3aian917 BY @Ooko0
#---------------------------------------------------------------------
]]
local function iaian917(msg,MsgText)

if msg.forward_info_ then return false end


if msg.Director 
and (redis:get(aian917..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(aian917..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(aian917..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(aian917..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)) and MsgText[1] ~= "الغاء" then 
return false end 
print(MsgText[1] )
print(MsgText[2] )
...
if not redis:get(aian917..'group:add'..msg.chat_id_) then return sendMsg(msg.chat_id_,msg.id_,'-› المستخدم ( '..NameUser..' ) \n-› المجموعه بالتأكيد تم تعطيلها . ️️') end  
rem_data_group(msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,'-› المستخدم ( '..NameUser..' ) \n-› تم تعطيل المجموعه . ️️')
end,{msg=msg})
end
...
local msgs = redis:get(aian917..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
local edited = (redis:get(aian917..':edited:'..arg.chat_id_..':'..arg.sender_user_id_) or 0)
...
local KleshaID = '- الأيـدي || '..arg.sender_user_id_..'.\n'
    ...
    ..'• الرسائل || '..arg.msgs..'.\n• القـناه   || @OOKO0 .'
local Kleshaidinfo = redis:get(aian917..":infoiduser_public:"..arg.chat_id_) or redis:get(aian917..":infoiduser")  

if Kleshaidinfo then 
local points = redis:get(aian917..':User_Points:'..arg.chat_id_..arg.sender_user_id_) or 0
...
KleshaID = KleshaID:gsub("{البوت}",redis:get(aian917..':NameBot:'))
...
local GroupName = (redis:get(aian917..'group:name'..arg.ChatID) or '')
redis:set(aian917..'linkGroup'..arg.ChatID,(data.invite_link_ or ""))
...
if not msg.Director and redis:get(aian917..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(aian917..":MsgIDPin:"..arg.ChatID,arg.reply_id)
...
if not msg.Admin then return "-› هذا الامر يخص ( Legend , Staff , المنشئ , المدير ) فقط ." end
if not msg.Director and redis:get(aian917..'lock_pin'..msg.chat_id_) then return "لا يمكنك الغاء التثبيت الامر مقفول من قبل الاداره" end
...
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك تقييد Legend  .\n") 
elseif redis:sismember(aian917..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك تقييد Staff .\n") 
elseif redis:sismember(aian917..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك تقييد المنشئ .\n") 
elseif redis:sismember(aian917..':MONSHA_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك تقييد المنشئ الاساسي .\n") 
elseif redis:sismember(aian917..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك تقييد المدير .\n") 
elseif redis:sismember(aian917..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك تقييد الادمن .\n") 
elseif  redis:sismember(aian917..'whitelist:'..arg.ChatID,UserID) then 
...
redis:set(aian917..":TqeedUser:"..arg.ChatID..arg.UserID,true)
...
if data.status_.ID == "ChatMemberStatusMember" then 
Restrict(arg.ChatID,arg.UserID,1)  
sredis:set(aian917..":TqeedUser:"..arg.ChatID..arg.UserID,true)
...
elseif UserID == SUDO_ID then 
return sendMsg(msg.chat_id_,msg.id_,"*-›* لا يمكنك تقييد Legend  .\n") 
elseif redis:sismember(aian917..':SUDO_BOT:',UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"*-›* لا يمكنك تقييد Staff .\n") 
elseif redis:sismember(aian917..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"*-›* لا يمكنك تقييد المنشئ .\n") 
elseif redis:sismember(aian917..':MONSHA_Group:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"*-›* لا يمكنك نقييد المنشئ الاساسي .\n") 
elseif redis:sismember(aian917..'owners:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"*-›* لا يمكنك تقييد المدير .\n") 
elseif redis:sismember(aian917..'admins:'..msg.chat_id_,UserID) then 
...
redis:del(aian917..":TqeedUser:"..arg.ChatID..UserID)
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم فك تقييده . ️") 
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
...
redis:del(aian917..":TqeedUser:"..arg.ChatID..arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم فك تقييده  من المجموعه . ️") 
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(aian917..'whitelist:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد رفعه مميز  . ️") 
else
redis:hset(aian917..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(aian917..'whitelist:'..arg.ChatID,arg.UserID)
...
if redis:sismember(aian917..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد رفعه مميز  . ️") 
end
redis:hset(aian917..'username:'..UserID,'username',UserName)
redis:sadd(aian917..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم رفعه مميز بنجاح . ️") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
NameUser = Hyper_Link_Name(data)
if not redis:sismember(aian917..'whitelist:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد تنزيله مميز . ️") 
else
redis:srem(aian917..'whitelist:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم رفعه مميز . ️") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
GetUserName(MsgText[2],function(arg,data)
if not data.id_ then return sendMsg(arg.ChatID,arg.MsgID,"-› لا يوجد عضـو بهذا المعرف \n") end 
local UserID = data.id_um
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(aian917..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم  بالتأكيد تنزيله مميز . ️")
else
redis:srem(aian917..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم رفعه مميز . ️") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not msg.Creator then return "-› هذا الامر يخص ( Legend , Staff , المنشئ ) فقط  ." end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"-› عذرا هذا العضو ليس موجود ضمن المجموعات .\n") end
local UserID = data.sender_user_id_
...
if redis:sismember(aian917..'owners:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتاكيد رفعه مدير . ️")
else
redis:hset(aian917..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(aian917..'owners:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم رفعه مدير .") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(aian917..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد رفعه مدير . ️")
else
redis:hset(aian917..'username:'..UserID, 'username',UserName)
redis:sadd(aian917..'owners:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم رفعه مدير .")
...
if not redis:sismember(aian917..'owners:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد تنزيله مدير . ️") 
else
redis:srem(aian917..'owners:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم تنزيله مدير . ️") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
if not redis:sismember(aian917..'owners:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد تنزيله مدير . ️")  
else
redis:srem(aian917..'owners:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم تنزيله مدير . ️") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not msg.SuperCreator then return "-› هذا الامر يخص ( Legend , Staff ) فقط   " end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"-› عذرا هذا العضو ليس موجود ضمن المجموعات .\n") end
local UserID = data.sender_user_id_
...
if redis:sismember(aian917..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتاكيد رفعه منشئ .  ️") 
else
redis:hset(aian917..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(aian917..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتاكيد رفعه منشئ .") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(aian917..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتاكيد رفعه منشئ .  ️") 
else
redis:hset(aian917..'username:'..UserID,'username',UserName)
redis:sadd(aian917..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتاكيد رفعه منشئ .") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(aian917..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد تنزيله منشئ .") 
else
redis:srem(aian917..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم تنزيله منشئ  .") 
end
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(aian917..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد تنزيله منشئ .️") 
else
redis:srem(aian917..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم تنزيله منشئ  .️") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
if not MsgText[2] and msg.reply_id then
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"-› عذرا هذا العضو ليس موجود ضمن المجموعات \n") end
local UserID = data.sender_user_id_
...
ReUsername = ResolveUserName(data)
NameUser   = Hyper_Link_Name(data)
if redis:sismember(aian917..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد رفعه ادمن .️") 
else
redis:hset(aian917..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(aian917..'admins:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم رفعه ادمن .️") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(aian917..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد رفعه ادمن .") 
else
redis:hset(aian917..'username:'..UserID,'username',UserName)
redis:sadd(aian917..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم رفعه ادمن . ️") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(aian917..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم  بالتأكيد تنزيله ادمن  .️") 
else
redis:srem(aian917..'admins:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم تنزيله ادمن  ️.") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
local UserID = data.id_
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(aian917..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم  بالتأكيد تنزيله ادمن  .️") 
else
redis:srem(aian917..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم تنزيله ادمن  .") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
local maseegs = redis:get(aian917..'msgs:'..arg.UserID..':'..arg.ChatID) or 1
local edited = redis:get(aian917..':edited:'..arg.ChatID..':'..arg.UserID) or 0
local content = redis:get(aian917..':adduser:'..arg.ChatID..':'..arg.UserID) or 0
...
NameUser = Hyper_Link_Name(data)
local maseegs = redis:get(aian917..'msgs:'..UserID..':'..arg.ChatID) or 1
local edited = redis:get(aian917..':edited:'..arg.ChatID..':'..UserID) or 0
local content = redis:get(aian917..':adduser:'..arg.ChatID..':'..UserID) or 0
...
local UserID = data.sender_user_id_
GetUserID(UserID,function(arg,data)
if msg.SudoBase then redis:srem(aian917..'gban_users',arg.UserID)  end 
Restrict(arg.ChatID,arg.UserID,2)
redis:srem(aian917..'banned:'..arg.ChatID,arg.UserID)
StatusLeft(arg.ChatID,arg.UserID)
redis:srem(aian917..'is_silent_users:'..arg.ChatID,arg.UserID)
NameUser = Hyper_Link_Name(data)
...
if not data.id_ then return sendMsg(arg.ChatID,arg.MsgID,"-› لآ يوجد عضـو بهذا آلمـعرف \n") end 
local UserID = data.id_
if msg.SudoBase then redis:srem(aian917..'gban_users',UserID)  end 
Restrict(arg.ChatID,UserID,2)
redis:srem(aian917..'banned:'..arg.ChatID,UserID)
StatusLeft(arg.ChatID,UserID)
redis:srem(aian917..'is_silent_users:'..arg.ChatID,UserID)
NameUser = Hyper_Link_Name(data)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم رفع القيود ان وجد   ️") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
if msg.SudoBase then redis:srem(aian917..'gban_users',MsgText[2])  end 
...
if not msg.Admin then return "-› هذا الامر يخص ( Legend , Staff , المنشئ , المدير ) فقط ." end
if not msg.Creator and not redis:get(aian917.."lock_KickBan"..msg.chat_id_) then return "-› الامر معطل من قبل اداره المجموعة   " end
...
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك طرد Legend \n") 
elseif redis:sismember(aian917..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك طرد Staff\n") 
elseif redis:sismember(aian917..':MONSHA_BOT:'..arg.ChatID,UserID) then 
...
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك حظر Legend \n") 
elseif redis:sismember(aian917..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك حظر Staff\n") 
elseif redis:sismember(aian917..':MONSHA_BOT:'..arg.ChatID,UserID) then 
...
NameUser = Hyper_Link_Name(data)
USERNAME = ResolveUserName(data)
if redis:sismember(aian917..'banned:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد حظره  .️") 
end

redis:hset(aian917..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(aian917..'banned:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم حظره بنجاح ️") 
end,{ChatID=arg.ChatID,UserID=arg.UserID,MsgID=arg.MsgID})
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
...
if redis:sismember(aian917..'banned:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد حظره .️") 
end
kick_user(UserID,arg.ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
redis:hset(aian917..'username:'..arg.UserID, 'username',arg.UserName)
redis:sadd(aian917..'banned:'..arg.ChatID,arg.UserID)
...
if not msg.SuperCreator then return "-› هذا الامر يخص ( Legend , Staff , المنشئ ) فقط   " end
...
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"*-›* عذرا هذا معرف قناة وليس حساب \n") end
redis:hset(aian917..'username:'..arg.UserID,'username',USERNAME)
redis:setex(aian917..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,500,NameUser)
redis:setex(aian917..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,500,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"*-›* عذرا هذا معرف قناة وليس حساب \n") end
redis:hset(aian917..'username:'..UserID,'username',arg.USERNAME)
redis:setex(aian917..":uploadingsomeon:"..arg.ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(aian917..":uploadingsomeon2:"..arg.ChatID..msg.sender_user_id_,500,UserID)
sendMsg(arg.ChatID,arg.MsgID,"- » حسننا الان ارسل صلاحيات المشرف :\n\n-›1- صلاحيه تغيير المعلومات\n-›2- صلاحيه حذف الرسائل\n-›3- صلاحيه دعوه مستخدمين\n-›4- صلاحيه حظر وتقيد المستخدمين \n-›5- صلاحيه تثبيت الرسائل \n-›6- صلاحيه رفع مشرفين اخرين\n\n-›[*]- لرفع كل الصلاحيات ما عدا رفع المشرفين \n-›[**] - لرفع كل الصلاحيات مع رفع المشرفين \n\n-› يمكنك اختيار الارقام معا وتعيين القـب للمشرف في ان واحد مثلا : \n\n-› 136 ايان \n") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,USERNAME=MsgText[2]})
...
GetChatMember(arg.ChatID,arg.UserID,function(arg,data)
if (data.status_.ID == "ChatMemberStatusKicked" or redis:sismember(aian917..'banned:'..arg.ChatID,arg.UserID)) then
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(aian917..'banned:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد الغاء حظره .") 
else
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم الغاء حظره بنجاح .") 
end
...
elseif UserID == SUDO_ID then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك كتم Legend \n") 
elseif redis:sismember(aian917..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* لا يمكنك كتم Staff\n") 
elseif redis:sismember(aian917..':MONSHA_BOT:'..arg.ChatID,UserID) then 
...
USERNAME = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(aian917..'is_silent_users:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد كتمه  .") 
else
redis:hset(aian917..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(aian917..'is_silent_users:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم كتمه بنجاح .️") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
if redis:sismember(aian917..'is_silent_users:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد كتمه .️") 
else
redis:hset(aian917..'username:'..UserID,'username',UserName)
redis:sadd(aian917..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم كتمه بنجاح .") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then 
...
if not redis:sismember(aian917..'is_silent_users:'..arg.ChatID,arg.UserID) then 
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(aian917..'is_silent_users:'..arg.ChatID,UserID) then 
...
if not msg.Creator  then return "-› هذا الامر يخص ( Legend , Staff , المنشئ , المدير ) فقط   " end 
redis:setex(aian917..'WiCmdLink'..msg.chat_id_..msg.sender_user_id_,500,true)
return '-› حسننا عزيزي  \n-› الان ارسل  رابط مجموعتك '
end

if MsgText[1] == "انشاء رابط" then
if not msg.Creator then return "-› هذا الامر يخص ( Legend , Staff , المنشئ , المدير ) فقط  " end
if not redis:get(aian917..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(aian917..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(aian917..'ExCmdLink'..msg.chat_id_,120,true)
...
if not redis:get(aian917.."lock_linkk"..msg.chat_id_) then return "*-›* الامر معطل من قبل الادارة \n"  end
if not redis:get(aian917..'linkGroup'..msg.chat_id_) then return "*-›* اوه  لا يوجد رابط ️\n*-›*لانشاء رابط ارسل { انشاء رابط } \n" end
local GroupName = redis:get(aian917..'group:name'..msg.chat_id_)
local GroupLink = redis:get(aian917..'linkGroup'..msg.chat_id_)
...
redis:set(aian917..'num_msg_max'..msg.chat_id_,MsgText[2]) 
...
if not msg.Creator then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
local NumLoop = tonumber(MsgText[2])
redis:set(aian917..':Timer_Cleaner:'..msg.chat_id_,NumLoop) 
...
sendMsg(msg.chat_id_,msg.id_,"*-›* تم مسح  { *"..MsgText[2].."* } من الرسائل   ️")
end,nil)
else
tdcli_function({ID="DeleteMessages",chat_id_=msg.chat_id_,message_ids_=All_Msgs},function() 
sendMsg(msg.chat_id_,msg.id_,"*-›* تم مسح  { *"..MsgText[2].."* } من الرسائل   ️")
...
if not msg.SudoUser then return "-› هذا الامر يخص ( Legend , Staff ) فقط  " end

local Admins = redis:scard(aian917..':MONSHA_Group:'..msg.chat_id_)
if Admins == 0 then  
return "*-›* اوه  هنالك خطأ \n-› عذرا لا يوجد منشئيين اساسييين ليتم مسحهم  ️" 
end
redis:del(aian917..':MONSHA_Group:'..msg.chat_id_)
return "-› المستخدم  "..msg.TheRankCmd.."   \n-› تم مسح {"..Admins.."} من الادمنيه في البوت  ️"
end

if MsgText[2] == "الادمنيه" then 
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end

local Admins = redis:scard(aian917..'admins:'..msg.chat_id_)
if Admins == 0 then  
return "*-›* اوه  هنالك خطأ \n-› عذرا لا يوجد ادمنيه ليتم مسحهم  ️" 
end
redis:del(aian917..'admins:'..msg.chat_id_)
return "-› المستخدم  "..msg.TheRankCmd.."   \n-› تم مسح {"..Admins.."} من الادمنيه في البوت  ️"
end
...
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
local Mn3Word = redis:scard(aian917..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "*-›* عذرا لا توجد كلمات ممنوعه ليتم حذفها  ️" 
end
redis:del(aian917..':Filter_Word:'..msg.chat_id_)
...
redis:del(aian917..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
if not redis:get(aian917..'welcome:msg'..msg.chat_id_) then 
return "*-›* اوه  هنالك خطأ \n-› عذرا لا يوجد ترحيب ليتم مسحه  ️" 
end
redis:del(aian917..'welcome:msg'..msg.chat_id_)
...
if not msg.SuperCreator    then return "-› هذا الامر يخص ( Legend , Staff , المنشئ ) فقط  ." end
local NumMnsha = redis:scard(aian917..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "-› عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(aian917..':MONSHA_BOT:'..msg.chat_id_)
...
if not msg.Creator then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
local NumMDER = redis:scard(aian917..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return "-› عذرا لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(aian917..'owners:'..msg.chat_id_)
...
local list = redis:smembers(aian917..'banned:'..msg.chat_id_)
if #list == 0 then return "*-› لا يوجد مستخدمين محظورين  *" end
message = '*-›* قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(aian917..'banned:'..msg.chat_id_)
return "-› المستخدم  "..msg.TheRankCmd.."   \n-›  تم مسح {* "..#list.." *} من المحظورين   ️"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
local MKTOMEN = redis:scard(aian917..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "*-›* لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(aian917..'is_silent_users:'..msg.chat_id_)
return "-› المستخدم  "..msg.TheRankCmd.."   \n-›  تم مسح {* "..MKTOMEN.." *} من المكتومين   ️"
end

if MsgText[2] == 'المميزين' then
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
local MMEZEN = redis:scard(aian917..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return "*⚙️*-› لا يوجد مستخدمين مميزين في المجموعه " 
end
redis:del(aian917..'whitelist:'..msg.chat_id_)
return "-› المستخدم  "..msg.TheRankCmd.."   \n-›  تم مسح {* "..MMEZEN.." *} من المميزين   ️"
end

if MsgText[2] == 'الرابط' then
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
if not redis:get(aian917..'linkGroup'..msg.chat_id_) then 
return "*⚙️*-› لا يوجد رابط مضاف اصلا " 
end
redis:del(aian917..'linkGroup'..msg.chat_id_)
...
if not msg.Admin then return "-› هذا الامر يخص ( Legend , Staff , المنشئ , المدير ) فقط ." end
redis:setex(aian917..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(aian917..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "-› هذا الامر يخص ( Legend , Staff , المنشئ , المدير ) فقط ." end
redis:setex(aian917..'about:witting'..msg.sender_user_id_,300,true) 
...
if redis:sismember(aian917..':Filter_Word:'..arg.ChatID,Type_id) then 
return sendMsg(arg.ChatID,arg.MsgID,"*-›* هي بالتأكيد في قائمه المنع ️️")
else
redis:sadd(aian917..':Filter_Word:'..arg.ChatID,Type_id) 
...
if redis:sismember(aian917..':Filter_Word:'..arg.ChatID,Type_id) then 
redis:srem(aian917..':Filter_Word:'..arg.ChatID,Type_id) 
...
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ) فقط  " end
...
TextR = TextR.."-› تم طـرد كل البوتات بنجآح .\n"
end
end
...
kick_user(v.user_id_,arg.ChatID,function(arg,data)  
redis:srem(aian917..':MONSHA_BOT:'..arg.ChatID,v.user_id_)
redis:srem(aian917..'whitelist:'..arg.ChatID,v.user_id_)
redis:srem(aian917..'owners:'..arg.ChatID,v.user_id_)
redis:srem(aian917..'admins:'..arg.ChatID,v.user_id_)
end)
end
NumMem = NumMem + 1
...
redis:setex(aian917..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(aian917..'CheckExpire::'..msg.chat_id_) then 
redis:set(aian917..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'-› تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ...')
sendMsg(SUDO_ID,0,'-› تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... \n️‍️-› في مجموعه  » »  '..redis:get(aian917..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "-› هذا الامر يخص ( Legend , Staff ) فقط  " end
if MsgText[2] == '1' then
redis:setex(aian917..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(aian917..'CheckExpire::'..msg.chat_id_) then 
redis:set(aian917..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'-› تم تفعيل الاشتراك  \n-›  الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'-› تم تفعيل الاشتراك \n-›  الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(aian917..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(aian917..'CheckExpire::'..msg.chat_id_) then 
redis:set(aian917..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(aian917..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(aian917..'CheckExpire::'..msg.chat_id_) then 
redis:set(aian917..'CheckExpire::'..msg.chat_id_,true) end
...
if not msg.Admin then return "-› هذا الامر يخص ( Legend , Staff , المنشئ , المدير ) فقط ." end
local check_time = redis:ttl(aian917..'ExpireDate:'..msg.chat_id_)
...
Getrtb = 'Legend  ' 
elseif redis:sismember(aian917..':SUDO_BOT:',arg.UserID) then
Getrtb = 'مطور ' 
elseif redis:sismember(aian917..':MONSHA_Group:'..arg.ChatID,arg.UserID) then
Getrtb = 'منشى اساسي' 
elseif redis:sismember(aian917..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
Getrtb = 'منشئ' 
elseif redis:sismember(aian917..'owners:'..arg.ChatID,arg.UserID) then
Getrtb = 'المدير ' 
elseif redis:sismember(aian917..'admins:'..arg.ChatID,arg.UserID) then
Getrtb = 'ادمن' 
elseif redis:sismember(aian917..'whitelist:'..arg.ChatID,arg.UserID) then
Getrtb = 'مميز' 
else
Getrtb = 'عضو' 
end
...
if data.status_.ID ~= "ChatMemberStatusMember" then 
sendMsg(arg.ChatID,arg.MsgID,'*-›* جيد يشتغل بشكل ممتاز . \n')
else 
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(aian917..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(aian917..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(aian917..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(aian917..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(aian917..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(aian917..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(aian917..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(aian917..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(aian917..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if MsgText[1]== '' then
return '🧟‍♂*-›*  عدد جهہآتگ آلمـضـآفهہ‏‏ » ('..(redis:get(aian917..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..') . \n🐾'
end
...
if not msg.SudoBase then return "-› هذا الامر يخص ( Legend , Staff ) فقط  " end
local mtwren = redis:scard(aian917..':SUDO_BOT:')
if mtwren == 0 then  return "️*-›* عذرا لا يوجد مطورين في البوت  " end
redis:del(aian917..':SUDO_BOT:') 
return "-› تم مسح {* "..mtwren.." *} من المطورين ️ ️"
end

if MsgText[1] == 'مسح' and MsgText[2] == "قائمه العام"  then
if not msg.SudoBase then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
local addbannds = redis:scard(aian917..'gban_users')
if addbannds ==0 then 
return "*️-› قائمة الحظر فارغه .*" 
end
redis:del(aian917..'gban_users') 
return "️*-›* تم مـسـح { *"..addbannds.." *} من قائمه العام ️" 
end 
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(aian917..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتاكيد رفعه منشئ اساسي .") 
else
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتاكيد رفعه منشئ اساسي .  ️") 
redis:hset(aian917..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(aian917..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if redis:sismember(aian917..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتاكيد رفعه منشئ اساسي .") 
else
redis:hset(aian917..'username:'..UserID,'username',arg.UserName)
redis:sadd(aian917..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتاكيد رفعه منشئ اساسي .  ️") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not redis:sismember(aian917..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد تنزيله منشئ اساسي .️") 
else
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم تنزيله منشئ اساسي  بنجاح .️") 
redis:srem(aian917..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
UserName = Flter_Markdown(arg.UserName)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(aian917..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد تنزيله منشئ اساسي  .️") 
else
redis:srem(aian917..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم تنزيله منشئ اساسي  .️")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not msg.SudoBase then return "-› هذا الامر يخص -› هذا الامر يخص ( Legend , Staff ) فقط فقط   " end
redis:del(aian917..":awamer_Klesha_m1:")
redis:del(aian917..":awamer_Klesha_m2:")
redis:del(aian917..":awamer_Klesha_m3:")
redis:del(aian917..":awamer_Klesha_mtwr:")
redis:del(aian917..":awamer_Klesha_mrd:")
redis:del(aian917..":awamer_Klesha_mf:")
redis:del(aian917..":awamer_Klesha_m:")
...
redis:del(aian917..":infoiduser_public:"..msg.chat_id_)
...
if not msg.Creator then return "-› هذا الامر يخص {منشئ اساسي,المنشئ,المطور} فقط   " end
redis:setex(aian917..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
elseif redis:sismember(aian917..'admins:'..msg.chat_id_,UserID) then 
rinkuser = 6
elseif redis:sismember(aian917..'whitelist:'..msg.chat_id_,UserID) then 
rinkuser = 7
else
rinkuser = 8
end
local DonisDown = "\n-› تم تنزيله من الرتب الاتيه : \n\n "
if redis:sismember(aian917..':SUDO_BOT:',UserID) then 
DonisDown = DonisDown.."-› تم تنزيله من Staff  ️️\n"
end 
if redis:sismember(aian917..':MONSHA_Group:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."-› تم تنزيله من المنشئ الاساسي  ️️\n"
end 
if redis:sismember(aian917..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."-› تم تنزيله من المنشئ  ️️\n"
end 
if redis:sismember(aian917..'owners:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."-› تم تنزيله من المدير  ️️\n"
end 
if redis:sismember(aian917..'admins:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."-› تم تنزيله من الادمن  ️️\n"
end 
if redis:sismember(aian917..'whitelist:'..msg.chat_id_,UserID) then
...
redis:srem(aian917..':SUDO_BOT:',UserID)
redis:srem(aian917..':MONSHA_Group:'..msg.chat_id_,UserID)
redis:srem(aian917..':MONSHA_BOT:'..msg.chat_id_,UserID)
redis:srem(aian917..'owners:'..msg.chat_id_,UserID)
redis:srem(aian917..'admins:'..msg.chat_id_,UserID)
redis:srem(aian917..'whitelist:'..msg.chat_id_,UserID)
...
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
local list = redis:hgetall(aian917..":AwamerBotArray2:"..msg.chat_id_)
local list2 = redis:hgetall(aian917..":AwamerBotArray:"..msg.chat_id_)
...
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
local Awammer 	= redis:del(aian917..":AwamerBot:"..msg.chat_id_)
redis:del(aian917..":AwamerBotArray:"..msg.chat_id_)
redis:del(aian917..":AwamerBotArray2:"..msg.chat_id_)
if Awammer ~= 0 then
...
for k, aian917 in pairs(Xaian917) do if MsgText[2]:match(aian917) then  checkAmr = true end end      
if checkAmr then
redis:setex(aian917..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,300,MsgText[2])
return "-› حسننا عزيزي , لتغير امر {* "..MsgText[2].." *}  ارسل الامر الجديد الان \n..."
else
return "-› عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره   "
end
else
redis:setex(aian917..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
if MsgText[2] then
local checkk = redis:hdel(aian917..":AwamerBotArray2:"..msg.chat_id_,MsgText[2])
local AmrOld = redis:hgetall(aian917..":AwamerBotArray:"..msg.chat_id_)
amrnew = ""
amrold = ""
...
redis:hdel(aian917..":AwamerBotArray:"..msg.chat_id_,Amor)
...
redis:setex(aian917..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(aian917..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(aian917..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '*-›* ارسل امر القائمه المراد تعيينهم مثل الاتي "\n-›`الاوامر` , `م1` , `م2 `, `م3 `, `م المطور ` , `اوامر الرد `,  `اوامر الملفات` \n' 
end


if MsgText[1] == "رفع Staff" then
if not MsgText[2] and msg.reply_id then 
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
if not data.sender_user_id_ then return sendMsg(arg.ChatID,arg.MsgID,"-› عذرا هذا العضو ليس موجود ضمن المجموعات \n") end
local UserID = data.sender_user_id_
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(aian917..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم رفعه بنجاح .  ️") 
else
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم رفعه بنجاح ️") 
redis:hset(aian917..'username:'..arg.UserID,'username',RUSERNAME)
redis:sadd(aian917..':SUDO_BOT:',arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
redis:hset(aian917..'username:'..UserID,'username',ReUsername)
redis:sadd(aian917..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم رفعه بنجاح ️") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(aian917..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتاكيد تنزيله من رتبه Staff ️") 
else
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم تنزيله من رتبه Staff ") 
redis:srem(aian917..':SUDO_BOT:',arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if not redis:sismember(aian917..':SUDO_BOT:',UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتاكيد تنزيله من رتبه Staff ") 
else
redis:srem(aian917..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم تنزيله من رتبه Staff ") 
end
...
local groups = redis:smembers(aian917..'group:ids')
...
local pv = redis:smembers(aian917..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(aian917..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(aian917..':WELCOME_BOT')
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[-› مـرحبآ آنآ بوت آسـمـي ]]..redis:get(aian917..':NameBot:')..[[ 🎖
...
redis:setex(aian917..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '-› حسننا عزيزي \n-› الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(aian917..':addnumberusers',MsgText[2]) 
return '💱*-›* تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *('..MsgText[2]..')* عضـو  \n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'*-›* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *('..redis:get(aian917..':addnumberusers')..')* عضـو  \n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات " then 
if not msg.SudoUser then return "-› هذا الامر يخص ( Legend , Staff ) فقط  " end
return '*-›* عدد المجموعات المفعلة » `'..redis:scard(aian917..'group:ids')..'`  ' 
end
...
if not msg.SudoUser then return "-› هذا الامر يخص ( Legend , Staff ) فقط  " end
if not msg.SudoBase and not redis:get(aian917.."lockidedit") then return "-› الامر معطل من قبل Legend    " end
redis:del(aian917..":infoiduser")
...
if not msg.SudoUser then return "-› هذا الامر يخص ( Legend , Staff ) فقط  " end
if not msg.SudoBase and not redis:get(aian917.."lockidedit") then return "-› تعيين الايدي معطل من قبل Legend    " end
redis:setex(aian917..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '*-›* حسننا , الان ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n قناه تعليمات ونشر كلايش الايدي \n قناه الكلايش : [] \n' 
end
...
return redis:get(aian917..":TEXT_SUDO") or '-› لا توجد كليشه المطور .\n-› يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه بالتثبيت"  or MsgText[1] =="اذاعه بالتثبيت " then
if not msg.SudoUser then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
if not msg.SudoBase and not redis:get(aian917..'lock_brod') then return "*-›* الاذاعه مقفوله من قبل Legend    " end
redis:setex(aian917..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "-› حسننا الان ارسل رساله ليتم اذاعتها بالتثبيت  \n" 
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه " then
if not msg.SudoUser then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
if not msg.SudoBase and not redis:get(aian917..'lock_brod') then 
return "*-›* الاذاعه مقفوله من قبل Legend    " 
end
redis:setex(aian917..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(aian917..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(aian917..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(aian917..'fwd:groups'..msg.sender_user_id_,300, true) 
...
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد حظره عام  من المجموعات  ️") 
else
redis:hset(aian917..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(aian917..'gban_users',arg.UserID)
kick_user(arg.UserID,arg.ChatID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم حظره عام  من المجموعات  ️") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
if redis:sismember(aian917..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد حظره عام  من المجموعات  ️") 
else
redis:hset(aian917..'username:'..UserID,'username',UserName)
redis:sadd(aian917..'gban_users',UserID)
...
if GeneralBanned(arg.UserID) then 
redis:srem(aian917..'gban_users',arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد الغاء حظره العام  من المجموعات  ️") 
else
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم الغاء حظره العام  من المجموعات  ️") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.reply_id})
end
...
if not redis:sismember(aian917..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم بالتأكيد الغاء حظره العام  من المجموعات  ️") 
else
redis:srem(aian917..'gban_users',UserID)
return sendMsg(arg.ChatID,arg.MsgID,"-› العضو ( "..NameUser.." ) \n-› تم الغاء حظره العام  من المجموعات  ️") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not msg.Admin then return "-› هذا الامر يخص ( Legend , Staff , المنشئ , المدير ) فقط ." end
redis:del(aian917..'welcom:witting'..msg.sender_user_id_,
aian917..'rulse:witting'..msg.sender_user_id_,
aian917..'rulse:witting'..msg.sender_user_id_,
aian917..'name:witting'..msg.sender_user_id_,
aian917..'about:witting'..msg.sender_user_id_,
aian917..'fwd:all'..msg.sender_user_id_,
aian917..'fwd:pv'..msg.sender_user_id_,
aian917..'fwd:groups'..msg.sender_user_id_,
aian917..'namebot:witting'..msg.sender_user_id_,
aian917..'addrd_all:'..msg.sender_user_id_,
aian917..'delrd:'..msg.sender_user_id_,
aian917..'addrd:'..msg.sender_user_id_,
aian917..'delrdall:'..msg.sender_user_id_,
aian917..'text_sudo:witting'..msg.sender_user_id_,
aian917..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
aian917..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,
aian917..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,
aian917..'addrd:'..msg.chat_id_..msg.sender_user_id_,
aian917..':KStart:'..msg.chat_id_..msg.sender_user_id_,
aian917.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_,
aian917..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,
aian917..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,
aian917..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,
aian917..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,
aian917..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,
aian917..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,
aian917..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
aian917..":ForceSub:"..msg.sender_user_id_,
aian917..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(aian917..":VERSION",GetVerison)
return false
else
...
if not msg.SudoBase then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
return 'الاحصائيات : \n\n*-›* عدد المجموعات المفعله : '..redis:scard(aian917..'group:ids')..'\n*-›* عدد المشتركين في البوت : '..redis:scard(aian917..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام " then
if not msg.SudoBase then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
redis:setex(aian917..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(aian917..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
redis:setex(aian917..':KStart:'..msg.chat_id_..msg.sender_user_id_,900,true)
...
if not msg.SudoBase then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
redis:del(aian917..':Text_Start')
return "-› تم مسح كليشه الستارت "
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
local names 	= redis:exists(aian917..'replay:'..msg.chat_id_)
local photo 	= redis:exists(aian917..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(aian917..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(aian917..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(aian917..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(aian917..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(aian917..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(aian917..'replay:'..msg.chat_id_,aian917..'replay_photo:group:'..msg.chat_id_,aian917..'replay_voice:group:'..msg.chat_id_,
aian917..'replay_animation:group:'..msg.chat_id_,aian917..'replay_audio:group:'..msg.chat_id_,aian917..'replay_sticker:group:'..msg.chat_id_,aian917..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(aian917..'replay:all')
local photo 	= redis:exists(aian917..'replay_photo:group:')
local voice 	= redis:exists(aian917..'replay_voice:group:')
local imation 	= redis:exists(aian917..'replay_animation:group:')
local audio 	= redis:exists(aian917..'replay_audio:group:')
local sticker 	= redis:exists(aian917..'replay_sticker:group:')
local video 	= redis:exists(aian917..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(aian917..'replay:all',aian917..'replay_photo:group:',aian917..'replay_voice:group:',aian917..'replay_animation:group:',aian917..'replay_audio:group:',aian917..'replay_sticker:group:',aian917..'replay_video:group:')
...
if not msg.SudoBase then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
redis:set(aian917..'delrdall:'..msg.sender_user_id_,true) 
return "-› حسننا عزيزي  \n-› الان ارسل الرد لمسحها من  المجموعات "
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
redis:set(aian917..'delrd:'..msg.sender_user_id_,true)
...
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
local names  	= redis:hkeys(aian917..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(aian917..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(aian917..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(aian917..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(aian917..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(aian917..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(aian917..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(aian917..'replay:all')
local photo 	= redis:hkeys(aian917..'replay_photo:group:')
local voice 	= redis:hkeys(aian917..'replay_voice:group:')
local imation 	= redis:hkeys(aian917..'replay_animation:group:')
local audio 	= redis:hkeys(aian917..'replay_audio:group:')
local sticker 	= redis:hkeys(aian917..'replay_sticker:group:')
local video 	= redis:hkeys(aian917..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '*-›* لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "-› هذا الامر يخص ( Legend , Staff , المنشئ, المدير )  فقط  " end
redis:setex(aian917..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(aian917..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "-› حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ' then
if not msg.SudoBase then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
redis:setex(aian917..'namebot:witting'..msg.sender_user_id_,300,true)
...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="اوامر الرد" or MsgText[1]=="الاوامر" or MsgText[1]=="اوامر الملفات") and redis:get(aian917..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(aian917..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_)
redis:setex(aian917..":changawmer:"..msg.chat_id_..msg.sender_user_id_,900,MsgText[1])
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(aian917..":awamer_Klesha_m:")
if textD then
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(aian917..":awamer_Klesha_m1:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(aian917..":awamer_Klesha_m2:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(aian917..":awamer_Klesha_m3:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(aian917..":awamer_Klesha_mtwr:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(aian917..":awamer_Klesha_mrd:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(aian917..":awamer_Klesha_mf:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
if not redis:get(aian917.."lock_leftgroup"..msg.chat_id_) then  return "-› امر المغادره معطل من قبل اداره المجموعة   " end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"‍️-› اهلا عزيزي , لقد تم طردك من المجموعه بامر منك \n-› اذا كان هذا بالخطأ او اردت الرجوع للمجموعه \n\n-›فهذا رابط المجموعه \n-›"..Flter_Markdown(redis:get(aian917..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(aian917..'linkGroup'..msg.chat_id_).."]\n")
...
return [[
[𝘤𝘩𝘢𝘯𝘯𝘦𝘭 𝘴𝘰𝘶𝘳𝘤𝘦](http://t.me/AIIANN)

[𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 🚨](http://t.me/SYY_Y)
...
if not msg.SudoBase then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
if redis:get(aian917..":UserNameChaneel") then
return "-› اهلا عزيزي المطور \n-› الاشتراك بالتأكيد مفعل"
else
redis:setex(aian917..":ForceSub:"..msg.sender_user_id_,350,true)
...
if not msg.SudoBase then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
local SubDel = redis:del(aian917..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"-› هذا الامر يخص ( Legend , Staff ) فقط  " end
local UserChaneel = redis:get(aian917..":UserNameChaneel")
if UserChaneel then
...
local function daian917(msg)

if msg.type == "pv" then 

if not msg.SudoUser then
local msg_pv = tonumber(redis:get(aian917..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(aian917..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*-›* تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(aian917..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then

if msg.SudoBase then
local text = '-› اهلاً عزيزي آلمـطـور \n-› نورت بستخدام سورس ايان \n...\n\n-› تسـتطـيع‏‏ التحكم بكل الاوامر الموجودة بالكيبورد\n️-› فقط آضـغط ع آلآمـر آلذي تريد تنفيده'
...
redis:sadd(aian917..'users',msg.sender_user_id_)
SUDO_USER = redis:hgetall(aian917..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
SUDO_USERR = "️-› مـعرف آلمـطـور  : "..SUDO_USER
else
...
text = [[-› اهلاً آنآ بوت آسـمـي []]..redis:get(aian917..':NameBot:')..[[] 
-› آختصـآصـي حماية المجموعات
-› ارفعني مشرف واكتب تفعيل فقط .
]]..SUDO_USERR..[[

]]
GetUserID(msg.sender_user_id_,function(arg,data)
if data.last_name_ then Name = data.first_name_ .." "..data.last_name_ else Name = data.first_name_ end
text = redis:get(aian917..':Text_Start') or text
local edited = (redis:get(aian917..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local points = redis:get(aian917..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
local Emsgs = redis:get(aian917..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
text = text:gsub("{البوت}",redis:get(aian917..':NameBot:'))
...
local MSG_ID = (redis:get(aian917.."USER_MSG_TWASEL"..data.forward_info_.date_) or 1)
msg = arg.msg
local SendOk = false
...
SendMention(arg.sender_user_id_,data.id_,arg.id_,"-› تم آرسـآل الرساله \n-› آلى : "..USERNAME.." ",39,utf8.len(USERNAME)) 
...
return sendMsg(msg.chat_id_,msg.id_,"-› عذرآ لآ يمكنك آرسـآل (ملف , توجيه‌‏ , مـلصـق , فديو ) ️")
end
SUDO_USER = redis:hgetall(aian917..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
SUDO_USERR = "\n "..SUDO_USER
...
redis:setex(aian917.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
sendMsg(msg.chat_id_,msg.id_,"-› تم آرسـآل رسالتك آلى آلمـطـور\n-› سيتم الرد عليك بأقرب وقت["..SUDO_USERR.."]")
...
--====================== Reply Only Group =====================================
if redis:get(aian917..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(aian917..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(aian917..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.content_ and msg.content_.caption_ then redis:hset(aian917..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then 
redis:del(aian917..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
redis:hset(aian917..'replay:'..msg.chat_id_,klma,msg.text)
...
redis:hset(aian917..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(aian917..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'-› تم اضافه صوره للرد بنجاح  ️\n-› يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(aian917..'replay_voice:group:'..msg.chat_id_,klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(aian917..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'-› تم اضافه بصمه صوت للرد بنجاح  ️\n-› يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(aian917..'replay_animation:group:'..msg.chat_id_,klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(aian917..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'-› تم اضافه متحركه للرد بنجاح  ️\n-› يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(aian917..'replay_video:group:'..msg.chat_id_,klma,msg.content_.video_.video_.persistent_id_)
redis:del(aian917..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'-› تم اضافه فيديو للرد بنجاح  ️\n-› يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(aian917..'replay_audio:group:'..msg.chat_id_,klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(aian917..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'-› تم اضافه للصوت للرد بنجاح  ️\n-› يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageSticker" then
redis:hset(aian917..'replay_sticker:group:'..msg.chat_id_,klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(aian917..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(aian917..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(aian917..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(aian917..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.caption_ then redis:hset(aian917..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then
redis:del(aian917..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then 
return sendMsg(msg.chat_id_,msg.id_,"-› عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر\n")
end
redis:hset(aian917..'replay:all',klma,msg.text)
...
redis:hset(aian917..'replay_photo:group:',klma,photo_id)
redis:del(aian917..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'-› تم اضافه صوره للرد العام  ️\n-› يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(aian917..'replay_voice:group:',klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(aian917..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'-› تم اضافه بصمه صوت للرد العام  ️\n-› يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(aian917..'replay_animation:group:',klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(aian917..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'-› تم اضافه متحركه للرد العام  ️\n-› يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(aian917..'replay_video:group:',klma,msg.content_.video_.video_.persistent_id_)
redis:del(aian917..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'-› تم اضافه فيديو للرد العام  ️\n-› يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(aian917..'replay_audio:group:',klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(aian917..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'-› تم اضافه للصوت للرد العام  ️\n-› يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageSticker" then
redis:hset(aian917..'replay_sticker:group:',klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(aian917..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if msg.Director and (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(aian917.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(aian917.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_)
redis:set(aian917..'linkGroup'..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"-› تم تعيين الرابط بنجاح  ")
return false
end

if msg.Creator and redis:get(aian917..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(aian917..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_)
redis:set(aian917..":infoiduser_public:"..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"-› تم تعيين كليشة الايدي بنجاح \n-› يمكنك تجربة الامر الان ")
return false
end

if msg.SuperCreator and redis:get(aian917..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_) then 

NameUser = redis:get(aian917..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
UserID = redis:get(aian917..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
if not msg.text:match("[1234567]") and not msg.text:match("[*]") and not msg.text:match("[*][*]") then
redis:del(aian917..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
redis:del(aian917..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(aian917..'admins:'..msg.chat_id_,UserID)
local trues = " ️"
local falses = "✖️"
...
if msg.Creator and redis:get(aian917..":changawmer:"..msg.chat_id_..msg.sender_user_id_) and not redis:get(aian917..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
...
local amr = redis:get(aian917..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
if amr == "م1" then
redis:set(aian917..":awamer_Klesha_m1:",msg.text)
elseif amr == "م2" then
redis:set(aian917..":awamer_Klesha_m2:",msg.text)
elseif amr == "م3" then
redis:set(aian917..":awamer_Klesha_m3:",msg.text)
elseif amr == "م المطور" then
redis:set(aian917..":awamer_Klesha_mtwr:",msg.text)
elseif amr == "اوامر الرد" then
redis:set(aian917..":awamer_Klesha_mrd:",msg.text)
elseif amr == "اوامر الملفات" then
redis:set(aian917..":awamer_Klesha_mf:",msg.text)
elseif amr == "الاوامر" then
redis:set(aian917..":awamer_Klesha_m:",msg.text)
end
redis:del(aian917..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,"-› تم تعيين كليشة التعليمات بنجاح \n-› يمكنك تجربة الامر *("..amr.."}* ")
end


if msg.SudoUser and redis:get(aian917..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(aian917..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_)
redis:set(aian917..":infoiduser",msg.text)
sendMsg(msg.chat_id_,msg.id_,"-› تم تعيين كليشة الايدي بنجاح \n-› يمكنك تجربة الامر الان ")
return false
end
...
if msg.Director and redis:get(aian917..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(aian917..":AwamerBotArray2:"..msg.chat_id_)
Amr = redis:get(aian917..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
local checknewamr = false
for k, aian917 in pairs(Xaian917) do 
local cceck,sec = aian917:gsub("[(]"..Amr.."[)]","("..msg.text..")")
if sec ~= 0 then
redis:hset(aian917..":AwamerBotArray:"..msg.chat_id_,cceck,aian917)
redis:hset(aian917..":AwamerBotArray2:"..msg.chat_id_,msg.text,Amr)
end
end  
...
redis:hset(aian917..":AwamerBot:"..msg.chat_id_,msg.text,Amr)
sendMsg(msg.chat_id_,msg.id_,"-› تم تغيير الامر القديم ["..Amr.."] \n-› الى الامر الجديد ["..msg.text.."]\n...")
end
redis:del(aian917..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and not redis:get(aian917..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) and redis:get(aian917..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(aian917..":AwamerBotArray2:"..msg.chat_id_)
local Amr = redis:get(aian917..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
...
redis:del(aian917..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and redis:get(aian917..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) then
local checkAmr = false
for k, aian917 in pairs(Xaian917) do if msg.text:match(aian917) then checkAmr = true end end      
if checkAmr then
sendMsg(msg.chat_id_,msg.id_,"-› حسننا عزيزي , لتغير امر (* "..msg.text.." *} \n-› ارسل الامر الجديد الان \n...")
redis:setex(aian917..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,900,msg.text)
else
sendMsg(msg.chat_id_,msg.id_,"-› عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره   ")
end
redis:del(aian917..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
if msg.Director and redis:get(aian917..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) then
local checkk = redis:hdel(aian917..":AwamerBotArray2:"..msg.chat_id_,msg.text)
...
redis:del(aian917..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
local checkk = redis:hdel(aian917..":AwamerBot:"..msg.chat_id_,msg.text)
if checkk ~=0 then
tiires =  "-› تم مسح الامر {* "..msg.text.." *} من قائمه الاومر \n..."
else
tiires = "-› هذا الامر ليس موجود ضمن الاوامر المضافه   "
...
if msg.SudoBase and redis:get(aian917..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_) then
...
redis:set(aian917..":SUDO_ID:",UserID)
local usero = arg.USERNAME:gsub([[\_]],"_")
redis:hset(aian917..'username:'..UserID,'username',usero)
...
redis:del(aian917..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_)
return false 
end


if redis:get(aian917..":ForceSub:"..msg.sender_user_id_) then
redis:del(aian917..":ForceSub:"..msg.sender_user_id_)
if msg.text:match("^@[%a%d_]+$") then
...
redis:set(aian917..":UserNameChaneel",msg.text)
...
if redis:get(aian917..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(aian917..'namebot:witting'..msg.sender_user_id_)
redis:set(aian917..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"-› تم تغير اسم البوت  \n-› الان اسمه "..Flter_Markdown(msg.text).."  ️")
return false
end

if redis:get(aian917..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(aian917..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"-› عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n")
end
redis:hdel(aian917..'replay_photo:group:',msg.text)
redis:hdel(aian917..'replay_voice:group:',msg.text)
redis:hdel(aian917..'replay_animation:group:',msg.text)
redis:hdel(aian917..'replay_audio:group:',msg.text)
redis:hdel(aian917..'replay_sticker:group:',msg.text)
redis:hdel(aian917..'replay_video:group:',msg.text)
redis:setex(aian917..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"-› جيد , يمكنك الان ارسال جوا ب الردالعام \n-› [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]  ️\n\n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n")
end
end

if redis:get(aian917..':KStart:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(aian917..':KStart:'..msg.chat_id_..msg.sender_user_id_)
redis:set(aian917..':Text_Start',msg.text)
...
if redis:get(aian917..'delrdall:'..msg.sender_user_id_) then
redis:del(aian917..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(aian917..'replay:all',msg.text)
local photo =redis:hget(aian917..'replay_photo:group:',msg.text)
local voice = redis:hget(aian917..'replay_voice:group:',msg.text)
local animation = redis:hget(aian917..'replay_animation:group:',msg.text)
local audio = redis:hget(aian917..'replay_audio:group:',msg.text)
local sticker = redis:hget(aian917..'replay_sticker:group:',msg.text)
local video = redis:hget(aian917..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'*-›* هذا الرد ليس مضاف في قائمه الردود ')
else
redis:hdel(aian917..'replay:all',msg.text)
redis:hdel(aian917..'replay_photo:group:',msg.text)
redis:hdel(aian917..'replay_voice:group:',msg.text)
redis:hdel(aian917..'replay_audio:group:',msg.text)
redis:hdel(aian917..'replay_animation:group:',msg.text)
...
if redis:get(aian917..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(aian917..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(aian917..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "*-›* تم وضع الكليشه بنجاح كلاتي \n\n*{*  "..Flter_Markdown(msg.text).."  *}* ️")
end
if redis:get(aian917..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(aian917..'welcom:witting'..msg.sender_user_id_) 
redis:set(aian917..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"*-›* تم وضع الترحيب بنجاح كلاتي  ️" )
end
if redis:get(aian917..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(aian917..'rulse:witting'..msg.sender_user_id_) 
redis:set(aian917..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'*-›* مرحبآ عزيزي\n-› تم حفظ القوانين بنجاح  ️\n-› ارسل [[ القوانين ]] لعرضها \n ️')
end
if redis:get(aian917..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(aian917..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(aian917..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(aian917..'about:witting'..msg.sender_user_id_) 
...
if redis:get(aian917..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(aian917..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(aian917..'users')  
local groups = redis:smembers(aian917..'group:ids')
...
return sendMsg(msg.chat_id_,msg.id_,'*-›* تم اذاعه الكليشه بنجاح \n*-›* للمـجمـوعآت » *'..#groups..'* قروب \n*-›* للمشتركين » '..#pv..' مشترك   ️')
end

if redis:get(aian917..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(aian917..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(aian917..'users')
if #pv >= 300 then
...
if redis:get(aian917..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(aian917..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(aian917..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(aian917..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
sendMsg(msg.chat_id_,msg.id_,'*-›* عدد المجموعات  { *'..#groups..'*  } \n*-›* تم الاذاعه بالتثبيت بنجاح  ️')
end 

if redis:get(aian917..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(aian917..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(aian917..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'-› اهلا عزيزي المطور \n-› جاري نشر الرساله للمجموعات ...')			
end
...
if msg.forward_info_ and redis:get(aian917..'fwd:'..msg.sender_user_id_) then
redis:del(aian917..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(aian917..'users')
local groups = redis:smembers(aian917..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(aian917..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(aian917..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(aian917..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,' -› تم تغيير صـورهہ‏‏ آلترحيب للبوت  ️')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(aian917..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(aian917..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(aian917..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(aian917..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"-› عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n")
end
redis:hdel(aian917..'replay:'..msg.chat_id_,msg.text)
redis:hdel(aian917..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(aian917..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(aian917..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(aian917..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(aian917..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(aian917..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(aian917..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"-› جيد , يمكنك الان ارسال جواب الرد \n-› [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] \n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n")
end
end

if redis:get(aian917..'delrd:'..msg.sender_user_id_) then
redis:del(aian917..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(aian917..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(aian917..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(aian917..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(aian917..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(aian917..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(aian917..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(aian917..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'*-›* هذا الرد ليس مضاف في قائمه الردود ')
else
redis:hdel(aian917..'replay:'..msg.chat_id_,msg.text)
...
print(" -- pinned -- ")
local msg_pin_id = redis:get(aian917..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and not msg.OurBot and redis:get(aian917..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(aian917..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(aian917..'group:name'..arg.chat_id_,arg.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if msg.content_.ID == "MessageChatAddMembers" and redis:get(aian917..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(aian917..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(aian917..'welcome:get'..msg.chat_id_)
end
redis:setex(aian917..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if (msg.content_.ID == "MessageChatAddMembers") then
if redis:get(aian917..'welcome:get'..msg.chat_id_) then
if msg.adduserType then
welcome = (redis:get(aian917..'welcome:msg'..msg.chat_id_) or "-› مرحباً عزيزي\n-› نورت المجموعة \n💂‍️")
welcome = welcome:gsub("{القوانين}", redis:get(aian917..'rulse:msg'..msg.chat_id_) or "-› مرحبأ عزيري  القوانين كلاتي \n-› ممنوع نشر الروابط \n-› ممنوع التكلم او نشر صور اباحيه \n-› ممنوع  اعاده توجيه \n-› ممنوع التكلم بلطائفه \n-› الرجاء احترام المدراء والادمنيه 😅\n")
if msg.addusername then UserName = '@'..msg.addusername else UserName = '< لا يوجد معرف >' end
local edited = (redis:get(aian917..':edited:'..msg.chat_id_..':'..msg.adduser) or 0)
local points = redis:get(aian917..':User_Points:'..msg.chat_id_..msg.adduser) or 0
local msgs = redis:get(aian917..'msgs:'..msg.adduser..':'..msg.chat_id_) or 1

if msg.adduser == SUDO_ID then 
gtupe = 'Legend ' 
elseif redis:sismember(aian917..':SUDO_BOT:',msg.adduser) then 
gtupe = 'Staff'
elseif msg.GroupActive and redis:sismember(aian917..':MONSHA_Group:'..msg.chat_id_,msg.adduser) then 
gtupe = 'منشئ اساسي'
elseif msg.GroupActive and redis:sismember(aian917..':MONSHA_BOT:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المنشىء'
elseif msg.GroupActive and redis:sismember(aian917..'owners:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المدير' 
elseif msg.GroupActive and redis:sismember(aian917..'admins:'..msg.chat_id_,msg.adduser) then 
gtupe = 'الادمن'
elseif msg.GroupActive and redis:sismember(aian917..'whitelist:'..msg.chat_id_,msg.adduser) then 
gtupe = 'عضو مميز'
...
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(aian917..'group:name'..msg.chat_id_) or '')))
...
local welcome = welcome:gsub("{البوت}",redis:get(aian917..':NameBot:'))
...
GetUserID(msg.sender_user_id_,function(arg,data)
welcome = (redis:get(aian917..'welcome:msg'..msg.chat_id_) or "-› مرحباً عزيزي\n-› نورت المجموعة \n‍️")
welcome = welcome:gsub("{القوانين}", redis:get(aian917..'rulse:msg'..msg.chat_id_) or "-› مرحبأ عزيري  القوانين  \n-› ممنوع نشر الروابط \n-› ممنوع التكلم او نشر صور اباحيه \n-› ممنوع  اعاده توجيه \n-› ممنوع التكلم بلطائفه \n-› الرجاء احترام المدراء والادمنيه \n")
...
if msg.edited and not msg.SuperCreator and redis:get(aian917.."antiedit"..msg.chat_id_) then 
...
local monsha = redis:smembers(aian917..':MONSHA_Group:'..msg.chat_id_)
Rwers = ""
...
local info = redis:hgetall(aian917..'username:'..v) if info and info.username and info.username:match("@[%a%d_]+") then usersmnc = usersmnc..info.username.." - " end
sendMsg(v,0,"-› هناك شخص قام بالتعديل \n-› الاسم : ( "..NameUser.." ) "..uuseri.."\n️-› الايدي : `"..msg.sender_user_id_.."`\n-› رتبته : "..Getrtba(msg.sender_user_id_,msg.chat_id_).."\n-› نوع التعديل : "..Rwers.."\n-› المجموعة : "..Flter_Markdown((redis:get(aian917..'group:name'..msg.chat_id_) or '')).."\n-› الرابط : "..redis:get(aian917..'linkGroup'..msg.chat_id_).." \n" )
end
end
...
if not msg.forward_info_ and msg.content_.ID ~= "MessagePhoto" and redis:get(aian917..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(aian917..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_MAX = (redis:get(aian917..'num_msg_max'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_MAX) then 
redis:setex(aian917..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood',30,true)
...
redis:setex(aian917..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end


if msg.forward_info_ then
if redis:get(aian917..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(aian917..'lock_woring'..msg.chat_id_) and not redis:get(aian917..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(aian917..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(aian917..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and msg.content_.ID ~= "MessageText" and redis:get(aian917..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data) 
...
return false
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(aian917..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(aian917..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
or msg.text:match("[Ww][Ww][Ww].") 
or msg.text:match(".[Cc][Oo][Mm]")) 
and redis:get(aian917..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(aian917..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(aian917..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("ه‍") or msg.text:match("ی") or msg.text:match("ک")) and redis:get(aian917.."lock_pharsi"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif KlmatMmno3(msg.text) and redis:get(aian917.."lock_mmno3"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("[a-zA-Z]") and redis:get(aian917.."lock_lang"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#.+") and redis:get(aian917..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(aian917..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(aian917..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(aian917..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(aian917..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessagePhoto" then
if redis:get(aian917..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(aian917..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageVideo" then
if redis:get(aian917..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(aian917..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageDocument" and redis:get(aian917..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageSticker" and redis:get(aian917..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAnimation" then
if redis:get(aian917..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(aian917..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageContact" and redis:get(aian917..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageLocation" and redis:get(aian917..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageVoice" and redis:get(aian917..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageGame" and redis:get(aian917..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAudio" and redis:get(aian917..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.reply_markup and  msg.reply_markup.ID == "replyMarkupInlineKeyboard" and redis:get(aian917..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(aian917..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(aian917..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(aian917..'replay'..msg.chat_id_) then

GetUserID(msg.sender_user_id_,function(arg,data)
local Replay = false

Replay = redis:hget(aian917..'replay:all',msg.text)
if Replay then
...
Replay = redis:hget(aian917..'replay:'..msg.chat_id_,msg.text)
if Replay then 
Replay = convert_Klmat(msg,data,Replay,true)
sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay)) 
return false
...
Replay = redis:hget(aian917..'replay_photo:group:',msg.text)
if Replay then 
Caption = redis:hget(aian917..':caption_replay:'..msg.chat_id_,msg.text)
...
Replay = redis:hget(aian917..'replay_voice:group:',msg.text)
if Replay then 
Caption = redis:hget(aian917..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(aian917..'replay_animation:group:',msg.text)
if Replay then 
Caption = redis:hget(aian917..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(aian917..'replay_audio:group:',msg.text)
if Replay then 
Caption = redis:hget(aian917..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(aian917..'replay_sticker:group:',msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(aian917..'replay_video:group:',msg.text)
if Replay then 
Caption = redis:hget(aian917..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(aian917..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(aian917..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendPhoto(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(aian917..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(aian917..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVoice(msg.chat_id_,msg.id_,Replay,Caption)
...
Replay = redis:hget(aian917..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(aian917..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAnimation(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(aian917..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(aian917..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAudio(msg.chat_id_,msg.id_,Replay,"",Caption)  
...
Replay = redis:hget(aian917..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(aian917..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(aian917..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVideo(msg.chat_id_,msg.id_,Replay,Caption)
...
if msg.text and redis:get(aian917.."lock_rdodSource"..msg.chat_id_) then
...
elseif Text:match("^بوسطسطسطتيميجسنيتيصهيا(.*)$") then 
if msg.reply_id then 
...
elseif not msg.SudoUser and Text== "" or Text== "" or Text== "" or Text== "" or Text== "" or Text== "" or Text== "" then
...
elseif not msg.SudoUser and Text== "" or Text== "" or Text== "" or Text== "" or Text== "" or Text== "" or Text== "" or Text== "" or Text== "" then
...
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"لو لا الحاضرين تفلت بخشمّك ")
elseif Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[🚨 ألعولقي .](t.me/SYY_Y")
elseif Text== "سورس من" then return sendMsg(msg.chat_id_,msg.id_,"[🚨 نهيان .](t.me/lll9D")
elseif Text== "مصطفى" then return sendMsg(msg.chat_id_,msg.id_,"[. تفضل](t.me/SYY_Y")
elseif Text== "سورس مين" then return sendMsg(msg.chat_id_,msg.id_,"[🚨 ألعولقي .](t.me/SYY_Y")
elseif Text== "نهيان احمد" then return sendMsg(msg.chat_id_,msg.id_,"[🚨 نهيان .](t.me/lll9D")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"[‹ سـيدالرجـال](t.me/BYYYY")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"[‹ شـادي](t.me/KKFKK")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"[مطـور سورس بـرليـنِ](t.me/KKFKK")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"[مطـور سورس بـرليـنِ](t.me/KKFKK")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"جـيتك")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"ارحب")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"ف قـلبك")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"من بعـدك")
...
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"بخيـر يعيني ")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"من بععد نـورك")
elseif Text== "" and not is_sudo then return sendMsg(msg.chat_id_,msg.id_,"يديـم مبسمّك")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"عخـدك الحلو ")
elseif Text== "" or Text== "" then return  sendMsg(msg.chat_id_,msg.id_,"العفـو")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"فقـلبك")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"عيـونك اخر امالي .")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"تكـره اللي يحبك")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"كم المـدة؟️")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"الله يرزقك بسـالفة.")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"موبكـثري.")
elseif Text== "" or Text=="" then return  sendMsg(msg.chat_id_,msg.id_,"اطلق جـيه.")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"هـياط ادول .")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"علـيهم بالعافية .'")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"لبـيه امـر.")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"اطلق جـيه .")
elseif Text== "" or Text=="" then return sendMsg(msg.chat_id_,msg.id_,"شتشـوف ؟")
elseif Text== "" or Text== "" then return sendMsg(msg.chat_id_,msg.id_,"مخـليه لاشكالك .")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"ليه الحِلو زعلان")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"شفيـه الحلو زعلان")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"قوم كل")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"الله لـنا")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"مِن بععدك حلفت.")
elseif Text== "" or Text== "" then return sendMsg(msg.chat_id_,msg.id_,"اكثـريعيني.")
elseif Text== "" or Text== "" or Text== "" then return  sendMsg(msg.chat_id_,msg.id_,"مخـليه لك .")
elseif Text:match(Bot_Name.."") then 
return sendMsg(msg.chat_id_,msg.id_,"يـزين المهتم .")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"مجـار من الفدا.")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"موبكثـري")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"موبكـثري")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"امـريعيني")
...
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"اهلاً عزيزي .")
elseif Text== "" or Text== "" or Text== "" or Text=="" or Text=="" then 
return sendMsg(msg.chat_id_,msg.id_,"وعلـيك السلام عيني " )
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"لبـيه" )
elseif Text== "‍"  then return sendMsg(msg.chat_id_,msg.id_,"ع ويـن ي الحبيب")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"لا جـالس")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"سلامتـك")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"سـلامتك")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"اطلق هـلو ، و هـلو .")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"بعمرك انا اكذب عليك")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"امـريقلبي")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"اخليك بزاويه 380 درجه وانته تعرف الباقي")
elseif Text== "" or Text== ""  then return  sendMsg(msg.chat_id_,msg.id_,"مجـار من الففدا " )
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"لعرض قائمة المساعدة اكتب الاوامر 🌚❤️")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"ممره.")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"موبحلاوتك")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"قـيدام")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"تعيـش ايامك")
elseif Text== "" or Text== "" then return sendMsg(msg.chat_id_,msg.id_,"تشـم عطرها")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"وش تـشوف؟")
elseif Text== "" or Text=="" then return sendMsg(msg.chat_id_,msg.id_,"مجـار من الففدا")
elseif Text== "" or Text== "" then return  sendMsg(msg.chat_id_,msg.id_,"ع كيـفك الدنيا")
elseif Text== "" or Text=="" then return  sendMsg(msg.chat_id_,msg.id_,"امـريقلبي")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"ف الخـاص مو هنا ")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"احب حيـاتك")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"يحمي عممرك")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"اكيـه")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"بعشـقك")
elseif Text== "" or Text=="" or Text=="" then return sendMsg(msg.chat_id_,msg.id_,"جعـل م يقول غييرك")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"امـريعيني")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"جععل م ياكلني غيرك")
elseif Text== "" or Text=="" or Text=="" or Text=="" then  
return sendMsg(msg.chat_id_,msg.id_,"")
elseif Text== ""  or Text== "" then return sendMsg(msg.chat_id_,msg.id_,"مبـسمّك الحِلو")
elseif Text== "" then return sendMsg(msg.chat_id_,msg.id_,"ف خدمـتك يقلبي")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"عقـلبك الحلو")
elseif Text== ""  or Text==  "" or Text==  "" then return sendMsg(msg.chat_id_,msg.id_,"امـريقلبي")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"من فـوق يعيني ")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"مبسمّك الحلو")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"شتـشوف ؟")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"شفـيك انت؟")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"مِن بععدك")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"النـور نورك")
elseif Text== ""  then return sendMsg(msg.chat_id_,msg.id_,"نـور الحاضرين يعيني")
elseif Text== "" then 
...
if redis:get(aian917..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(aian917..'ExpireDate:'..msg.chat_id_)
SUDO_USER = redis:hgetall(aian917..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
